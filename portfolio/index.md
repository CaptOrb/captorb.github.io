  ...
  <div class="tw-max-w-7xl tw-mx-auto tw-px-4 sm:tw-px-6 lg:tw-px-8">
    ...
    <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 lg:tw-grid-cols-3 tw-gap-8">
      ...
      <div class="tw-bg-white tw-rounded-lg tw-shadow-md tw-overflow-hidden hover:tw-shadow-lg tw-transition-shadow tw-duration-300 tw-flex tw-flex-col">
        ...
        <div class="p-6">
          ...
          <p class="text-gray-600 mb-4 h-24">Led end-to-end development from concept to deployment. Features JWT authentication, automated CI/CD via GitHub Actions, and 77% test coverage with JUnit and Mockito.</p>
    ...
    <div class="tw-mt-16">
      ...
      <div class="tw-grid tw-grid-cols-2 md:tw-grid-cols-4 lg:tw-grid-cols-6 tw-gap-4">
        ...
        <div class="tw-bg-white tw-p-4 tw-rounded-lg tw-shadow tw-text-center">
          <img class="tw-w-8 tw-h-8 tw-mx-auto tw-mb-2" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg" alt="PostgreSQL"/>
